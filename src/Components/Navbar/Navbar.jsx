...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#cdae91] px-4 py-6 shadow-md sticky z-50 top-0">
      <div className="container mx-auto">
        <div className="flex items-center justify-between text-xl">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <a
              href="/"
              className="font-dm-serif text-black hover:text-amber-900 transition duration-300"
            >
              Home
            </a>
            ...
            <div className="relative group ">
              <button className="font-dm-serif text-black hover:text-amber-900 transition duration-300">
                Menu
              </button>
